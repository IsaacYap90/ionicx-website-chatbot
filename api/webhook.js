...
function generateResponse(message) {
  ...
  if (lowerMsg.includes('hello') || lowerMsg.includes('hi') || lowerMsg.includes('hey') || lowerMsg.includes('who')) {
...
async function sendWhatsAppMessage(to, message) {
  try {
    ...
    console.log('Phone ID exists:', !!process.env.WHATSAPP_PHONE_NUMBER_ID);
